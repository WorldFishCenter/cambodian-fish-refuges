...
Water temperature and the aquatic_plant measurements appear to have
...
| col_name            | cnt |      pcnt |
|:--------------------|----:|----------:|
| water_temp          |  89 | 1.4808652 |
| aquatic_plant_index |  13 | 0.2163062 |
...
include, the plant index, dry_area, dry_depth, and perhaps visibility
and water level.
...
```
    ...
    ## -2.34557 -0.27072  0.06088  0.32942  1.06588 
    ## 
    ## Coefficients:
    ##              Estimate Std. Error t value Pr(>|t|)    
    ## (Intercept)  2.668924   0.021900 121.867   <2e-16 ***
    ## month2      -0.033352   0.017917  -1.861   0.0627 .  
    ## month5      -0.311152   0.017917 -17.366   <2e-16 ***
    ## month8      -0.344750   0.017881 -19.280   <2e-16 ***
    ## year2013    -0.012203   0.026834  -0.455   0.6493    
    ## year2014     0.027387   0.026825   1.021   0.3073    
    ## year2015    -0.005607   0.026825  -0.209   0.8344    
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    ## 
    ## Residual standard error: 0.4717 on 6003 degrees of freedom
    ## Multiple R-squared:  0.1009, Adjusted R-squared:  0.09999 
    ## F-statistic: 112.3 on 6 and 6003 DF,  p-value: < 2.2e-16
...
```
    ...
    ## Residuals:
    ##      Min       1Q   Median       3Q      Max 
    ## -2.49682 -0.29758  0.05025  0.37240  1.09890 
    ## 
    ## Coefficients:
    ##                      Estimate Std. Error t value Pr(>|t|)    
    ## (Intercept)         2.980e+00  7.649e-02  38.961  < 2e-16 ***
    ## water_level         1.271e-04  8.487e-05   1.497    0.134    
    ## aquatic_plant_area -1.074e-03  2.328e-04  -4.614 4.03e-06 ***
    ## brush_park          1.810e-04  2.726e-05   6.640 3.42e-11 ***
    ## water_temp         -1.675e-02  2.501e-03  -6.697 2.32e-11 ***
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    ## 
    ## Residual standard error: 0.488 on 5916 degrees of freedom
    ##   (89 observations deleted due to missingness)
    ## Multiple R-squared:  0.02106,    Adjusted R-squared:  0.0204 
    ## F-statistic: 31.82 on 4 and 5916 DF,  p-value: < 2.2e-16
