...
We will now group species by type to see if that simplifies things. But no... There seems to be a bit of a thing with category 1 sites (Reservoir for irrigation in upland area) which seem to have a higer proportion of grey species than the other categories. 
